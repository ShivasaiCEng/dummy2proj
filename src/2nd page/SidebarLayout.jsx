              ...
              {showGeneralForm && (
                <form className="mock-form">
                  ...
                  <div className="form-actions">
                    <button type="button" onClick={() => setShowGeneralForm(false)} className="cancel-btn">Cancel</button>
                    <button type="submit" className="upload-btn">Start Interview</button>
                  </div>
                </form>
              )}
            ...
            <div className="section-container">
              ...
              {showMockForm && (
                <form className="mock-form">
                  ...
                  <div className="form-actions">
                    <button type="button" onClick={() => setShowMockForm(false)} className="cancel-btn">Cancel</button>
                    <button type="submit" className="upload-btn">Start Interview</button>
                  </div>
                </form>
              )}
